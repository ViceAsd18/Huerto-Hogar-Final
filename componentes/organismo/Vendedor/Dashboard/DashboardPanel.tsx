...
import { Table, Card, Row, Col, Spin, Button, Alert } from "antd";
...
const DashboardPanel = () => {
    ...
    const cargarOrdenes = async () => {
        try {
            ...
            console.error(err);
            setError("Error al cargar las órdenes. Intenta refrescar.");
        } finally {
            setLoading(false);
        }
    };
    ...
    const columns: ColumnsType<Orden> = [
        { title: "ID Orden", dataIndex: "id_venta", key: "id_venta" },
        { title: "Cliente", dataIndex: ["usuario", "nombre"], key: "cliente" },
        {
            title: "Fecha",
        ...
        <>
            {error && (
                <Alert
                    ...
                    action={
                        <Button size="small" onClick={cargarOrdenes}>
                            Reintentar
                        </Button>
                    }
                />
            ...
            {loading ? (
                ...
                <>
                    ...
                    <Card
                        ...
                        extra={<Button onClick={cargarOrdenes}>Refrescar</Button>}
                    >
                        <Table
